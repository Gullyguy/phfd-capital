...
|------|-----|--------------|
| Primary | `#E71422` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary | `#101114` | `--color-secondary` |
| On Secondary | `#FFFFFF` | `--color-on-secondary` |
| Accent/CTA | `#E71422` | `--color-accent` |
| On Accent/CTA | `#FFFFFF` | `--color-on-accent` |
| Background | `#F5F5F2` | `--color-background` |
| Foreground | `#101114` | `--color-foreground` |
| Card | `#FFFFFF` | `--color-card` |
| Card Foreground | `#101114` | `--color-card-foreground` |
| Muted | `#E8E8E4` | `--color-muted` |
| Muted Foreground | `#5F6368` | `--color-muted-foreground` |
| Border | `#D8D8D2` | `--color-border` |
| Destructive | `#B80F1A` | `--color-destructive` |
| On Destructive | `#FFFFFF` | `--color-on-destructive` |
| Ring | `#E71422` | `--color-ring` |

**Color Notes:** Official PHFD red, financial black, warm paper, and high-contrast white. Brand fidelity overrides the generic fintech palette returned by the search.

### Typography

- **Heading Font:** Avenir Next, system sans fallback
- **Body Font:** Avenir Next, system sans fallback
- **Mood:** financial, trustworthy, professional, corporate, banking, serious
- **Loading:** Local system stack for zero third-party font requests and faster first render.
